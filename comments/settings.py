...
DEBUG_TOOLBAR_CONFIG = {"SHOW_TOOLBAR_CALLBACK": lambda *args, **kwargs: DEBUG}
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [(str(os.getenv('REDIS_HOST')), str(os.getenv('REDIS_PORT')))],
        },
    },
}
...
if USE_S3:
    ...
    DEFAULT_FILE_STORAGE = 'comments.storage_backends.PublicMediaStorage'
else:
    MEDIA_URL = '/media/'
